...
def show_main_page():
    ...
    st.sidebar.write("**Disclaimer**: The information provided on this app is for informational purposes only and should not be construed as financial advice. The stock price predictions and other financial data presented are based on historical data and predictive algorithms, which may not always be accurate. Investing in the stock market involves risk, including the potential loss of principal. You should conduct your own research, review your financial situation, and consult with a financial advisor before making any investment decisions.")
    ...
    if ticker:
        ...
        if data is not None:
            ...
            news_articles = fetch_news(ticker, max_articles=20)
            if news_articles:
...
def show_stock_prediction_page():
    ...
    # Add the stock prediction functionality here, if different from the main page

# Optional: Define other functions for additional pages or features
